...
![1](https://github.com/user-attachments/assets/6e93fcac-d5f7-4031-8208-a2d9852866e6)
...
![2](https://github.com/user-attachments/assets/41dfb1e1-5e61-4361-9ab6-54846b949b25)


#
쿠버환경에 root user 및 Privilege Mode로 실행되는 pod 를 실행한 이후 ->정책에 의해 탐지되는 모습 

![3](https://github.com/user-attachments/assets/10dc547a-5e28-4584-b0c6-54a6e697de34)


#서버에서 정책 중에 replica 최대 제한 수 10->2로 바꾼 후 쿠버에서는 deployment 의 replica 수를 1 -> 3 으로 늘린다 -> 정책에 의해 탐지되는 모습 

![4](https://github.com/user-attachments/assets/159c8a07-be57-40cd-b8f0-72fcbe85a246)
